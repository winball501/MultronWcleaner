...
**System Cleanup**
- Scan and remove junk files from 250+ supported applications, constantly updated (the database.txt file lives in a separate repo and can be extended by the community via    commits/PRs)
