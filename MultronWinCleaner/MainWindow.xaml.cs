...
namespace Multron_Win_Cleaner
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public void changedatabase(string line, string path, string statusnow, string statusto)
        {
            string[] lines = System.IO.File.ReadAllLines(path);
            line = line.Replace(Environment.UserName, "{##}");
            ...
            for (int i = 0; i < lines.Length; i++)
            {
                ...
                {
                    lines[i] = lines[i].Replace(statusnow, statusto);
             ...
             try
                {
                    while (true)
                    {
                        await main.Dispatcher.InvokeAsync(() =>
                        {
                            if (main.settings.chkAutoClean.IsChecked == true && main.onclean == 0)
                            {
                                if (main.settings.txtCleaningInterval.Text == minutes.ToString())
                                {
                ...
                try
                {
                    ...
                    else
                    {
                        await main.Dispatcher.InvokeAsync(() =>
                        {
                            if(main.autoclean == 1)
                            {
                                main.label1_Copy.Content = "Auto scan completed! + " + formatsize(totalsize) + "  Useless file found! " + DateTime.Now;
                            } else
                            {
                                main.label1_Copy.Content = "Scan completed! + " + formatsize(totalsize) + "  Useless file found! " + DateTime.Now;
                            }
        ...
        private void CheckBox1_Checked(object sender, RoutedEventArgs e)
        {
            ...
            fileContent = fileContent.Replace("themes:0", "");
            fileContent = fileContent.Trim().ToLower();
            if(!fileContent.Contains("themes:1"))
            {
                System.IO.File.WriteAllText(path, fileContent);
                System.IO.File.AppendAllText(path, "themes:1" + Environment.NewLine);
            }
        ...
        private void CheckBox1_Unchecked(object sender, RoutedEventArgs e)
        {
            ...
            fileContent = fileContent.Replace("themes:1", "");
            if(!fileContent.Contains("themes:0"))
            {
                System.IO.File.WriteAllText(path, fileContent);
                System.IO.File.AppendAllText(path, "themes:0" + Environment.NewLine);
            }
        ...
        private void CheckBox_Checked(object sender, RoutedEventArgs e)
        {
            ...
            if (checkBox != null)
            {
                ...
                } else
                {
                    ...
                    {
                        changedatabase(name + "=" + path, databasefile, "false", "true");
                    }
                }
        ...
        private void CheckBox_Unchecked(object sender, RoutedEventArgs e)
        {
            ...
            if (checkBox != null)
            {
                ...
                if (System.IO.File.Exists(databasefile))
                {
                    changedatabase(name + "=" + path, databasefile, "true", "false");
                }
            ...
            public async void run()
            {
                ...
                await main.Dispatcher.InvokeAsync(() =>
                {
                    if(main.autoclean == 1)
                    {
                        ...
                        main.label1_Copy.Content = "Auto Clean done! " + main.formatsize(tltlsize) + " Cleaned. " + DateTime.Now;
                    } else
                    {
                        long tltlsize = new System.IO.DriveInfo("c:\\").AvailableFreeSpace - totalsize;
                        main.label1_Copy.Content = "Cleaning done! " + main.formatsize(tltlsize) + " Cleaned. " + DateTime.Now;
                    }
