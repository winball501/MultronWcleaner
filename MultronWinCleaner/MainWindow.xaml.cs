        ...
        public class Clean
        {
            ...
            public async void run()
            {
                ...
                await main.Dispatcher.InvokeAsync(() =>
                {
                    if(main.autoclean == 1)
                    {
                        main.label1_Copy.Content = "Auto Clean done! " + main.formatsize(totalsize) + " Cleaned. " + DateTime.Now;
                    } else
                    {
                        main.label1_Copy.Content = "Cleaning done! " + main.formatsize(totalsize) + " Cleaned. " + DateTime.Now;
                    }
