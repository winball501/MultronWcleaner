            ...
            private async Task CleanDirectory(string path)
            {
                try
                {
                    ...
                    foreach (var file in files)
                    {
                        ...
                        await ShowStatus($"Deleting file: {file}");
                        ...
                        if (!main.settings.excludedfiles.Contains(file))
                        {
                            ...
                            {
                                await ShowStatus($"Cannot delete file: {file} - {ex.Message}");
                            }
                        }
                        Thread.Sleep(100);
                    }
                    ...
                    foreach (var dir in dirs)
                    {
                        ...
                        {
                            await ShowStatus($"Cannot delete directory: {dir} - {ex.Message}");
                        }
                        Thread.Sleep(100);
                    }
                }
                ...
                {
                    await ShowStatus($"Failed cleaning dir: {path} - {ex.Message}");
                }
            }
