                                    ...
                                    if (line.Contains("{##}"))
                                    {
                                        ...
                                        await main.Dispatcher.InvokeAsync(async () =>
                                        {
                                            ...
                                            foreach (string profileFolder in profileFolders)
                                            {
                                                ...
                                                if (folderName.Contains("Profile") || folderName.Contains("Default", StringComparison.OrdinalIgnoreCase) || folderName.Contains(".default-release", StringComparison.OrdinalIgnoreCase))
                                                {
                                                await main.Dispatcher.InvokeAsync(() =>
                                                {
                                                       ...
                                                       foreach(string item in profilelist.Items)
                                                        {
                                                            if(!File.Exists(item))
                                                            {
                                                                 profile = path + profilelist.Items[count];
                                                                profilelist.SelectedIndex = count;
                                                            }
                                                            count++;
                                                        }
