...
namespace Multron_Win_Cleaner
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public class Scan
        {
            ...
            public async Task<long> ScanWinSxsFolderAsync(string path)
            {
            ...
            public async Task run()
            {
                try
                {
                    ...
                    foreach (string directory in main.database)
                    {
                        ...
                        {
                            long winsxssize = await ScanWinSxsFolderAsync("C:\\Windows\\WinSxS");
                            totalsize += winsxssize;
                            checkboxData.Add(("WinSxS Folder=C:\\Windows\\WinSxS", winsxssize, "C:\\Windows\\WinSxS"));
                        } else
                        {
    ...
    : $"File to delete={item.file}={formatsize(item.size)}",
        ...
        public class Clean
        {
            ...
            public static async Task CleanupWinSxSWithRealProgress(
             string logPath,
            ...
            public async Task run()
            {
                ...
                if (main.database[0].Contains("WinSxS"))
                {
